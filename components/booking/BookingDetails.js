    ...
    <div className="container">
      <div className="row d-flex justify-content-between">
        <div className="col-12 col-lg-8 mt-5 booking-details">
          {booking && booking.room && booking.userId && (
            <>
              <h2 className="my-5">Booking # {booking._id}</h2>

              <h4 className="mb-4">User Info</h4>
              <p>
                <b>Name:</b> {booking.userId && booking.userId.name}
              </p>
              <p>
                <b>Email:</b> {booking.userId && booking.userId.email}
              </p>
              <p>
              ...
              <p>
                <b>Check In:</b>{" "}
                {new Date(booking.checkInDate.dateIn).toLocaleString("en-US")}
              </p>

              <p>
                <b>Check Out:</b>{" "}
                {new Date(booking.checkOutDate.dateOut).toLocaleString("en-US")}
              </p>
              ...
              {user && user.role === "admin" && (
                <>
                  <h4 className="my-4">M-PESA TRANSACTION ID</h4>
